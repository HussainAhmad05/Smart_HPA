...
def Monitor ():
    ...
    while Available_Replicas != Operational_Replicas:               # To accomodate pod initialization time
        ...
        Available_Replicas = "kubectl get deployment checkoutservice -o=jsonpath='{.status.availableReplicas}'"
        ...
        Replicas_CPU_usage = 'kubectl top pods -l app=checkoutservice'                                     # Monitoring CPU Usage per replica
    ...
    Desired_Replicas = "kubectl get deployment checkoutservice -o=jsonpath='{.spec.replicas}'"
    ...
    cpu_request = "kubectl get deployment checkoutservice -o=jsonpath='{.spec.template.spec.containers[0].resources.requests.cpu}'"
...
def checkoutservice(Test_Time):
    ...
    workbook = load_workbook('./Knowledge Base/checkoutservice.xlsx')
    ...
    workbook.save('./Knowledge Base/checkoutservice.xlsx')
