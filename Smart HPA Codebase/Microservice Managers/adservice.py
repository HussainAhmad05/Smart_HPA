...
def Monitor ():
    ...
    while Available_Replicas != Operational_Replicas:               # To accomodate pod initialization time
        ...
        Replicas_CPU_usage = 'kubectl top pods -l app=adservice'                                     # Monitoring CPU Usage per replica
...
def adservice(Test_Time):
    ...
    workbook = load_workbook('./Knowledge Base/adservice.xlsx')
    ...
    workbook.save('./Knowledge Base/adservice.xlsx')
